              ...
              {STATUS_EXAMPLES.map((s, i) => {
                ...
                return (
                  <div key={s.label} style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    <div style={{ background: bgCard, border: `1px solid ${border}`, borderRadius: 12, padding: '1.25rem 1.5rem', textAlign: 'center', minWidth: 130, boxShadow: '0 2px 8px rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                      <span className="status-pill" style={{ background: sc.bg, color: sc.color, display: 'inline-flex' }}>
                        {s.label}
                      </span>
